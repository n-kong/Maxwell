...
public class MaxwellConfig extends AbstractConfig {
	...
	public String datahubEndPoint;
	public String projectName;
	public String shardCount;
	public String lifeCycle;
	public String outputDataHubSize;
	public String outputDataHubInterval;
	...
	protected MaxwellOptionParser buildOptionParser() {
		...
		parser.accepts("output_file_tmp", "output file tmp path").withRequiredArg();
		...
		parser.accepts("accessId", "the datahub id").withRequiredArg();
		parser.accepts("accessKey", "the datahub key").withRequiredArg();
		parser.accepts("datahubEndPoint", "the datahub endpoint").withRequiredArg();
		parser.accepts("projectName", "the datahub projectname").withRequiredArg();
		parser.accepts("shardCount", "the datahub shard count").withRequiredArg();
		parser.accepts("lifeCycle", "the datahub life cycle").withRequiredArg();
		parser.accepts("output_datahub_size", "datahub list size").withRequiredArg();
		parser.accepts("output_datahub_interval", "output datahub timeout").withRequiredArg();
	...
	private void setup(OptionSet options, Properties properties) {
		...
		this.databaseName       = fetchOption("schema_database", options, properties, "fenghuo");
		...
		this.clientID           = fetchOption("client_id", options, properties, "fenghuo_client_id");
		...
		this.kafkaTopic         	= fetchOption("kafka_topic", options, properties, "fenghuo");
		...
		this.outputFileTmp = fetchOption("output_file_tmp", options, properties, null);
		...
		this.accessKey = fetchOption("accessKey", options, properties, null);
		this.datahubEndPoint = fetchOption("datahubEndPoint", options, properties, null);
		this.projectName = fetchOption("projectName", options, properties, null);
		this.shardCount = fetchOption("shardCount", options, properties, "1");
		this.lifeCycle = fetchOption("lifeCycle", options, properties, "7");
		this.outputDataHubSize = fetchOption("output_datahub_size", options, properties, "100");
		this.outputDataHubInterval = fetchOption("output_datahub_interval", options, properties, "10");
